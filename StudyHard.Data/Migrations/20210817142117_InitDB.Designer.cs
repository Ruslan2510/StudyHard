...
namespace StudyHard.Data.Migrations
{
    ...
    [Migration("20210817142117_InitDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StudyHard.Data.Entity.Test.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudyHard.Data.Entity.Test.Subject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("StudyHard.Data.Entity.Exam.ExamResult", b =>
                {
                    b.HasOne("StudyHard.Data.Entity.Test.Subject", "Subject")
            ...
            modelBuilder.Entity("StudyHard.Data.Entity.Task.TaskList", b =>
                {
                    b.HasOne("StudyHard.Data.Entity.Test.Category", "Category")
                        .WithMany("TaskLists")
